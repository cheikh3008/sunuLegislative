...
/**
 * @extends ServiceEntityRepository<Coalition>
 *
...
class CoalitionRepository extends ServiceEntityRepository
{
    ...
    public function add(Coalition $entity, bool $flush = false): void
    {
    ...
    public function remove(Coalition $entity, bool $flush = false): void
    {
